...
//         headers.set('Authorization', `Bearer ${AuthenticationService.getAuthentication().token}`);

//         try {
//             const resp = this.client.get<T>(this.createFullyQualifiedUrl(endpoint), {headers: new HttpHeaders({'Authorization': `Bearer ${AuthenticationService.getAuthentication().token}`})});
//             return resp;
//         } catch (e) {
//             return of(e);
//         }
...
//             if (!!AuthenticationService.getAuthentication().user) {
//                 config.headers["User-Id"] = AuthenticationService.getAuthentication().user.surrogateId;
//             }
