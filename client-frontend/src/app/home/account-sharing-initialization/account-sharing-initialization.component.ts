...
export class AccountSharingInitializationDialog implements OnInit {
  ...
  public async submit() {
    ...
    console.log(
      this.loginCountFormControl,
      this.loginCountFormControl.valid,
      this.timeMinutesCountFormControl,
      this.timeMinutesCountFormControl.valid,
      !!this.loginCountFormControl.errors,
      !!this.timeMinutesCountFormControl.errors
    );
